...
function extrasOf(id: string): ClipExtras {
  ...
  const fresh: ClipExtras = { id, experiment_id: null, variant: null, series_id: null, series_index: null, reframe_override: null, caption_style: {}, zeitmarken: [], effekte: null, musik: null };

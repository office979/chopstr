...
| `/projekte/[id]` | Leitet auf `/projekte/[id]/clips` weiter. Die eigene Projektseite gibt es nicht mehr: der Fortschritt der Analyse steht jetzt in der Clip-Liste, solange es keine Clips gibt, und verschwindet von selbst, sobald welche da sind. Die Adresse bleibt, damit alte Lesezeichen funktionieren. |
